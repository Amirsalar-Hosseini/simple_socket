...
def scan_domain(domain, start_port, end_port):
    print(f'[*] Starting TCP scan on host {domain} completed')
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 4:
        print("Usage: ./port_scanner.py <ip> <start por>t <end port>")
        print("Usage: ./port_scanner.py <domain> <start por>t <end port> -n")
